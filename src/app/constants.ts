...
export const mainLogoImage = "/assets/Images/mainLogo.png";
export const cafecokTextImage = "/assets/Images/cafecokText.png";
...
export const filterDatas = [
  ...
  },
  {
    category: "menu",
    title: "찾는 메뉴가 있나요?",
    data: ["아메리카노", "라떼", "베이커리", "밀크티", "아인슈페너", "티"],
  },
  {
    category: "theme",
    title: "원하는 테마가 있나요?",
...
export const planCafeHeader = {
  similarCafes: {
    ...
    subTitle:
      "방문지역, 날짜, 시간은 동일해요. 조금 더 걷거나 조건이 다를 수 있어요.",
  },
  recommendCafes: {
